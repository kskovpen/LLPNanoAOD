...
config.General.requestName = 'LLPminiAOD_SingleMuonA'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'run_LLPminiAOD.py'
...
config.Data.outLFNDirBase = '/store/user/lrygaard/TTALPs/backgrounds2018/SingleMuonA/LLPminiAOD/'
