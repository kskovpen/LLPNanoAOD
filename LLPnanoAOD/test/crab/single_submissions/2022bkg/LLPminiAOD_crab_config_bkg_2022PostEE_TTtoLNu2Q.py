...
config.General.workArea = '/afs/desy.de/user/l/lrygaard/TTALP/CMSSW_13_0_13/src/LLPNanoAOD/LLPnanoAOD/test/crab/crab_projects/crab_bkg_2022PostEE_AOD_v1'
config.General.requestName = 'TTtoLNu2Q_LLPminiAODv1'
config.section_('JobType')
config.JobType.numCores = 4
config.JobType.sendExternalFolder = False
config.JobType.pyCfgParams = ['nEvents=0', 'runOnData=False', 'nThreads=4', 'year=2022PostEE']
...
config.Data.outputDatasetTag = 'LLPminiAODv1_Run3Summer22EEDRPremix-124X_postEE_v1-v2'
