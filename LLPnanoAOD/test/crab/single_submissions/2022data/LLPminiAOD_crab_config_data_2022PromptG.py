...
config.General.requestName = 'MuonG_LLPminiAODv1'
config.section_('JobType')
config.JobType.numCores = 4
config.JobType.sendExternalFolder = False
config.JobType.pyCfgParams = ['nEvents=0', 'runOnData=True', 'nThreads=4', 'year=2022Prompt']
...
config.Data.outputDatasetTag = 'LLPminiAODv1_Run2022G-PromptReco-v1'
