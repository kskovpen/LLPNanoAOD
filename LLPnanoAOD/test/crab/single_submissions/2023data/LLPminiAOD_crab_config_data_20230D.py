...
config.General.workArea = '/afs/desy.de/user/l/lrygaard/TTALP/CMSSW_13_0_13/src/LLPNanoAOD/LLPnanoAOD/test/crab/crab_projects/crab_data_2023_AOD_v1'
config.General.requestName = 'Muon0D_LLPminiAODv1'
config.section_('JobType')
config.JobType.numCores = 4
config.JobType.sendExternalFolder = False
config.JobType.pyCfgParams = ['nEvents=0', 'runOnData=True', 'nThreads=4', 'year=2023']
...
config.Data.outputDatasetTag = 'LLPminiAODv1_Run2023D-PromptReco-v2'
